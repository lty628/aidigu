...
class User extends Model
{
	...
	{
		return User::where('uid', $userid)->field('uid,nickname,intro,sex,blog,head_image,head_image_info,province,city,follownum,fansnum,message_sum')->find();
	}
	public static function getUserSetting($userid)
	{
		return User::where('uid', $userid)->field('uid,nickname,head_image_info,username,email,phone,sex,intro,blog,head_image,province,city,follownum,fansnum,message_sum')->find();
	}
}