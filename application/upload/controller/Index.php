...
class Index extends Controller
{
    ...
    public function siteShare()
    {
        ...
        if ($type[1] == 'mp4') {
            ...
            $data['content'] = '<p>分享 '.$fileInfo['file_name'].'</p><p><audio controls="controls" onplay="stopOther()" preload="none" controlsList="nodownload" οncοntextmenu="return false" name="media"><source src="'.$fileInfo['file_path'].'" type="audio/mpeg"></audio></p>';
        } else {
