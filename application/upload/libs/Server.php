...
use app\upload\libs\Cache\Cacheable;
use app\upload\libs\Events\UploadMerged;
use app\upload\libs\Events\UploadCreated;
use app\upload\libs\Events\UploadComplete;
use app\upload\libs\Events\UploadProgress;
use app\upload\libs\Exception\FileException;
use app\upload\libs\Exception\ConnectionException;
use app\upload\libs\Exception\OutOfRangeException;
...
class Server extends AbstractServer
{
    ...
    {
        $class = 'app\upload\libs\Storge\\'.Config::get('storge.type');
        $file = new $class($meta['name'], $this->cache);
