...
Route::domain('m', function () {
	...
	Route::get('/page/:page$','wap/Index/blog')->pattern(['page'=>'[0-9]+']);
	// Route::get('ajax', '/index/ajax/ajax/');
	...
	Route::get('/:name/page/:page$', 'wap/Index/index')->pattern(['name' => '\w+', 'page'=>'[0-9]+']);
	...
	Route::get('/:name/fans/page/:page$', 'wap/Index/fans')->pattern(['name' => '\w+', 'page'=>'[0-9]+']);
	Route::get('/:name/concern/$', 'wap/Index/concern')->pattern(['name' => '\w+']);
	Route::get('/:name/concern/page/:page$', 'wap/Index/concern')->pattern(['name' => '\w+', 'page'=>'[0-9]+']);
	Route::get('/:name/own/$', 'wap/Index/own')->pattern(['name' => '\w+']);
	Route::get('/:name/own/page/:page$', 'wap/Index/own')->pattern(['name' => '\w+', 'page'=>'[0-9]+']);
	...
	Route::get('/:name/newreply/page/:page$', 'wap/Index/newreply')->pattern(['name' => '\w+', 'page'=>'[0-9]+']);
