...
function comdel(url){
	...
	function repost(obj, fromuid, msg_id) 
	{
		...
		layer.open({
		  ...
		  area: ['625px', '320px'], //宽高
		  title: "<b>转发：</b>"+repost,
		  content: '<div class="contents"><div class="post" id="postform"><div class="postad">&nbsp;</div><textarea placeholder="请输入转发内容" maxlength="2800" id="repostInput" onkeyup="check_len2()"></textarea><div class="postnow">你还可以发布<em id="leftlen2">2800</em>字</div><div class="tool-class"><i class="layui-icon layui-icon-face-smile-b" onclick="showEmoji(this)" style="margin: 10px;cursor:pointer;color: #ffa700;font-size:20px!important" title="表情"></i><div class="emojiHtml" style="display: none"></div></div></div></div>',
		  btn: ['转发',"取消"],
